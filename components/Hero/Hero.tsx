        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <p className="py-5 text-lg leading-normal text-gray-500 lg:text-lg xl:text-lg dark:text-gray-300">
              ...
              has seen him in various prominent roles in hospitals around India.
              This has not only added to his expertise but has provided him with
              vital exposure in the field. He has worked in prominent hospitals
              in India like Sir Ganga Ram Hospital, Delhi and Shalby Hospitals,
              Ahmedabad. {/* <br /> */}
