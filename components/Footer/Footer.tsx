          ...
          <div className="-mx-4 flex flex-wrap justify-between">
            <div className="px-4 my-4 w-full xl:w-1/5">
              ...
              <p className="text-justify">
                ...
                North India. He has professional experience, spanning many years
                has seen him in various prominent roles in hospitals around
                India.
              </p>
            </div>
            ...
            <div className="px-4 my-4 w-full sm:w-auto xl:w-1/5">
              ...
              <a
                href="#"
                className="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full hover:text-primary hover:border-blue-400"
              >
                <svg
                  className="w-4 h-4 fill-current"
                  xmlns="http://www.w3.org/2000/svg"
